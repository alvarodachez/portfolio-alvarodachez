...
export const TimeLineData = [
  ...
  { year: 2018, text: "Software Engineering" },
  { year: 2019, text: "Discovering web development" },
  { year: 2020, text: "Work in software companies" },
  { year: 2021, text: "Started my own personal projects" },
];
